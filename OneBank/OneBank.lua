--$Id: OneBank.lua 12749 2006-10-03 02:19:17Z kergoth $
OneBank = OneCore:NewModule("OneBank", "AceEvent-2.0", "AceHook-2.1", "AceDebug-2.0", "AceConsole-2.0", "AceDB-2.0")
local L = AceLibrary("AceLocale-2.1"):GetInstance("OneBank", true)
...
function OneBank:OnEnable()
	...
	self:Hook("PurchaseSlot", function() self.hooks.PurchaseSlot() self.bagPurchased = true end)
    self:Hook("CloseBankFrame", function() self.frame:Hide() self.hooks.CloseBankFrame() end)
