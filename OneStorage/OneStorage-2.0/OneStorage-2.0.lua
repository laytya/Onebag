...
local MINOR_VERSION = "$Revision: 11187 $"
...
OneStorage = AceLibrary("AceAddon-2.0"):new("AceEvent-2.0", "AceHook-2.1")
 
local AL = AceLibrary("AceLocale-2.1")

AL:RegisterTranslation("OneStorage", "enUS", function() return { ["Quiver"] = true, ["Soul Bag"] = true, ["Container"] = true, ["Bag"] = true, ["Player of Realm"] = true } end)
AL:RegisterTranslation("OneStorage", "zhCN", function() return { ["Quiver"] = "箭袋", ["Soul Bag"] = "灵魂袋", ["Container"] = "背包", ["Bag"] = "包裹", } end)
AL:RegisterTranslation("OneStorage", "deDE", function() return { ["Quiver"] = "K\195\182cher", ["Soul Bag"] = "Seelentasche", ["Container"] = "Beh\195\164lter", ["Bag"] = "Beh\195\164lter", } end)
AL:RegisterTranslation("OneStorage", "koKR", function() return { ["Quiver"] = "화살통", ["Soul Bag"] = "영혼의 가방", ["Container"] = "가방", ["Bag"] = "가방", } end)
AL:RegisterTranslation("OneStorage", "frFR", function() return { ["Quiver"] = "Carquois", ["Soul Bag"] = "Sac d'\195\162me", ["Container"] = "Conteneur", ["Bag"] = "Conteneur", } end)
...
function OneStorage:Initialize()
    ...
    self:SetupEventsAndInitialSave()
